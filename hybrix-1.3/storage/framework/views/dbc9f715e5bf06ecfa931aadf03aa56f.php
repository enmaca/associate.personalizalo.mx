                            ...
                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                ...
                                <div class="text-reset notification-item d-block dropdown-item position-relative unread-message">
                                    <div class="d-flex">
                                        <div class="position-relative me-3 flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-circle avatar-xs" alt="user-pic">
                                ...
                                <div class="text-reset notification-item d-block dropdown-item position-relative">
                                    <div class="d-flex">
                                        ...
                                        <div class="position-relative me-3 flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" class="rounded-circle avatar-xs" alt="user-pic">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user()->avatar): ?> <?php echo e(URL::asset('storage/images/users/'. Auth::user()->avatar)); ?> <?php else: ?> <?php echo e(URL::asset('storage/images/users/avatar-1.jpg')); ?> <?php endif; ?>" alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item " href="<?php echo e(url('logout')); ?>"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" key="t-logout">logout</span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="notification-group-list">
                            ...
                            <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-xs rounded-circle flex-shrink-0 me-2" />
                                    <div>
                            ...
                            <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-7.jpg')); ?>" alt="" class="avatar-xs rounded-circle flex-shrink-0 me-2" />
                                    <div>
                            ...
                            <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-xs rounded-circle flex-shrink-0 me-2" />
                                    <div>
...
</div><!-- /.modal --><?php /**PATH /Users/enriquemartinez/php-projects/hybrix-1.3/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>