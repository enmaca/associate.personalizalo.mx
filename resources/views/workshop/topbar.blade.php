            ...
            <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fs-16 fw-semibold"> Pedidos por elaborar</h6>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="#!" class="text-reset">{NUMERO DE PEDIDO}</a>
                                            </h6>
                                            <p class="mb-0 fs-13 text-muted">
                                                {BUILD INFO}: <span>{OTHERDATA}</span>
                                            </p>
                                        </div>
                                        <div class="px-2">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-dark rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown"  data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"><span class="notification-badge">4</span><span class="visually-hidden">notificaciones pendientes</span></span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <div class="dropdown-head rounded-top">
                            <div class="p-3 border-bottom border-bottom-dashed">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="mb-0 fs-16 fw-semibold"> Notificaciones <span class="badge text-danger  bg-danger-subtle fs-13 notification-badge"> 4</span></h6>
                                    </div>
                                    <div class="col-auto dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#">Eliminar Todas</a></li>
                                            <li><a class="dropdown-item" href="#">Marcar todas como leidas</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if(Auth::user()->avatar) {{ URL::asset('storage/images/users/'. Auth::user()->avatar) }} @else {{ URL::asset('build/images/default_avatar.png') }} @endif" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->first_name }}</span>
                                <span class="d-none d-xl-block ms-1 fs-13 text-reset user-name-sub-text"></span>
                            </span>
                        </span>
                    </button>
