    ...
    public function build(): void
    {
        ...
        $this->_content->setColumns([
            'hashId' => [
                ...
                'type' => 'primaryKey',
                'handler' =>  \App\Support\Workshop\OrderProductDynamicDetails\TbHandler\Id::class
            ],
            'related.name' => [
            ...
            'profit_margin' => [
                'tbhContent' => 'Margen',
                'handler' => \App\Support\Workshop\OrderProductDynamicDetails\TbHandler\ProfitMargin::class
            ],
            'subtotal' => [
                'tbhContent' => 'Subtotal'
            ],
